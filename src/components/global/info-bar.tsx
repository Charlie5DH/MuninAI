...
const InfoBar = ({ notifications, subAccountId, className, role }: InfoBarProps) => {
  ...
  return (
    <>
      <div
        className={twMerge(
          "fixed z-[20] md:left-[300px] left-0 right-0 top-0 px-3 py-2 bg-background/80 backdrop-blur-md flex gap-4 items-center border-b-[1px] ",
          className
        )}
      >
